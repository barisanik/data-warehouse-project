...
| Veri Çekme | Python ([get_data.py](https://github.com/barisanik/data-warehouse-project/blob/v1_local_docker/scripts/bronze/get_data.py)) |
| Simülasyon | Python ([simulate_ship_date.py](https://github.com/barisanik/data-warehouse-project/blob/v1_local_docker/scripts/bronze/simulate_ship_date.py)) |
...
<img width="16155" height="4590" alt="Architecture_v1_local_docker" src="https://github.com/user-attachments/assets/a10c1386-e887-4c51-bf63-6bd205ec1eb3" />
...
Projede kullanılan CSV dosyaları [datasets](https://github.com/barisanik/data-warehouse-project/tree/v1_local_docker/datasets) dizini altında yer almaktadır.
...
```
.env dosyası örneği için [.env - Sample](https://github.com/barisanik/data-warehouse-project/blob/v1_local_docker/.env%20-%20Sample) dosyasına göz atabilirsiniz.
...
| Ingestion | Python ([get_data.py](https://github.com/barisanik/data-warehouse-project/blob/v1_local_docker/scripts/bronze/get_data.py)) |
| Simulation | Python ([simulate_ship_date.py](https://github.com/barisanik/data-warehouse-project/blob/v1_local_docker/scripts/bronze/simulate_ship_date.py)) |
...
CSV files used in this project can be found under the [datasets](https://github.com/barisanik/data-warehouse-project/tree/v1_local_docker/datasets) directory.
API endpoints used:
- [Dummy JSON - Products](https://dummyjson.com/products?limit=1000)
- [Dummy JSON - Users](https://dummyjson.com/user?limit=10000)
- [Dummy JSON - Carts](https://dummyjson.com/carts?limit=10000)
...
```
Please see [.env - Sample](https://github.com/barisanik/data-warehouse-project/blob/v1_local_docker/.env%20-%20Sample) file for a sample file structure.
