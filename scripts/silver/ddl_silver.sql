/*
    ...
    Script Purpose: This script creates tables in the silver schema using CRM and ERP datasources. 
...
CREATE TABLE silver.crm_cust_info (
    ...
    dwh_create_date    DATETIME2 DEFAULT GETDATE() -- Added create date column for every table for logging data creation date.
);
GO
